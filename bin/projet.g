...
vars  : 'var' ( type ident {PtGen.pt(1);} {PtGen.pt(11);} ( ','  ident {PtGen.pt(1);} {PtGen.pt(11);}  )* ptvg  )+ {PtGen.pt(42);}
  ;
...
ecriture: 'ecrire' '(' expression {PtGen.pt(43);} ( ',' expression {PtGen.pt(43);}  )* ')'
   ;
  
affouappel
  : ident {PtGen.pt(40);} (    ':=' expression {PtGen.pt(41);} 
            |   (effixes (effmods)?)?  
           )
  ;
...
expression: (exp1) ('ou' {PtGen.pt(20);}  exp1 {PtGen.pt(20);} {PtGen.pt(27);}  )*
  ;
  
exp1  : exp2 ('et' {PtGen.pt(20);} exp2 {PtGen.pt(20);} {PtGen.pt(21);} )*
  ;
  
exp2  : 'non'  exp2 {PtGen.pt(20);} {PtGen.pt(28);}
  | exp3  
  ;
